<?php
namespace xing\contentSafe\sdk\aliyunCore\Profile;
/*
...
use xing\contentSafe\sdk\aliyunCore\Auth\Credential;
use xing\contentSafe\sdk\aliyunCore\Regions\EndpointProvider;
class DefaultProfile implements IClientProfile
{
	...
	public function getSigner()
	{
		...
		{
			self::$isigner = new \xing\contentSafe\sdk\aliyunCore\Auth\ShaHmac1Signer();
		}
		return self::$isigner;
	}
	...
	public static function addEndpoint($endpointName, $regionId, $product, $domain)
	{
		...
		\xing\contentSafe\sdk\aliyunCore\Regions\LocationService::addEndPoint($regionId, $product, $domain);
	}
	...
	private static function addEndpoint_($endpointName,$regionId, $product, $domain)
	{
		...
		$productsDomains = array(new \xing\contentSafe\sdk\aliyunCore\Regions\ProductDomain($product, $domain));
		$endpoint = new \xing\contentSafe\sdk\aliyunCore\Regions\Endpoint($endpointName, $regionIds, $productsDomains);
