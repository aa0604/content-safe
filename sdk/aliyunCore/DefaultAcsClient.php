<?php
namespace  xing\contentSafe\sdk\aliyunCore;
use xing\contentSafe\sdk\aliyunCore\Http\HttpHelper;
/*
...
class DefaultAcsClient implements IAcsClient
{
    ...
    public function __construct($iClientProfile)
    {
        ...
        $this->locationService = new \xing\contentSafe\sdk\aliyunCore\Regions\LocationService($this->iClientProfile);
    }
    ...
    {
        throw new \xing\contentSafe\sdk\aliyunCore\Exception\ServerException($respObject->Message, $respObject->Code, $httpStatus, $respObject->RequestId);
    }
